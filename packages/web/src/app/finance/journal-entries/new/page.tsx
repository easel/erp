        ...
        <div className="space-y-3">
          ...
          <div className="rounded-md border">
            ...
            {fields.map((field, index) => (
              <div key={field.id} className="grid grid-cols-[1fr_100px_120px_80px_1fr_40px] gap-2 px-3 py-2 border-t">
                <div>
                  <Input
                  ...
                  {errors.lines?.[index]?.accountId && (
                    <p className="text-xs text-destructive mt-1">{errors.lines[index].accountId.message}</p>
                  )}
                </div>
                ...
                <div>
                  ...
                  {errors.lines?.[index]?.amount && (
                    <p className="text-xs text-destructive mt-1">{errors.lines[index].amount.message}</p>
                  )}
                </div>
